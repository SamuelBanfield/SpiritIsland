...
class InvaderDeckBuilder:
    ...
    def generate_deck(self):
        ...
        invader_deck = self.generate_stage_1() + self.generate_stage_2() + self.generate_stage_3()

        return invader_deck

    def build_deck(self):
        """Function to be called when user wants the fixed invader deck."""
        invader_deck = self.build_stage_1() + self.build_stage_2() + self.build_stage_3()
    ...
    def build_stage_3(self):
        pool = [["mountain", "jungle"], ["mountain", "wetland"], ["sand", "jungle"], ["sand", "wetland"], ["jungle", "wetland"]]
        phase_1_deck = []
