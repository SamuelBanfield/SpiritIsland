...
class FearComponent(UIComponent):
    ...
    def render(self, dest: pygame.surface.Surface, hovered: bool):
        ...
        current_terror_level_image = terror_level_images[self._island.terror_handler.terror_level]
        ...
        fear_pool_text = FONT_SUPPLIER.get_font_size(24).render(
            f"{self._island.terror_handler.fear_earned}/{self._island.terror_handler.fear_capacity}", True, BLACK
        )
